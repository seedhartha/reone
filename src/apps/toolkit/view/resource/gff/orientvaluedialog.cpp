...
#include "orientvaluedialog.h"

namespace reone {

void OrientationFieldValueDialog::InitControls(const glm::quat &value) {
    auto wLabel = new wxStaticText(this, wxID_ANY, "W:");
    m_wCtrl = new wxTextCtrl(this, wxID_ANY, std::to_string(value.w));
    m_wCtrl->SetMinSize(wxSize {400, m_wCtrl->GetMinSize().GetHeight()});
    ...
    sizer->Add(m_wCtrl, wxSizerFlags(0).Expand().Border(wxALL, 3));
