...
private:
    ...
    struct MeshHeader {
        ...
        uint32_t offMdxVertices { 0 };
        uint32_t offMdxNormals { 0 };
        uint32_t offMdxVertexColors { 0 };
        uint32_t offMdxTexCoords1 { 0 };
        uint32_t offMdxTexCoords2 { 0 };
        uint32_t offMdxTexCoords3 { 0 };
        uint32_t offMdxTexCoords4 { 0 };
        uint32_t offMdxTanSpace { 0 };
        uint32_t unknown3[3];
