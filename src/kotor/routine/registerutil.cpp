...
void registerRoutinesTSL(IRoutines &routines) {
    ...
    routines.add("GetItemPossessor", VT_O, {VT_O}, &routine::getItemPossessor);
    routines.add("GetItemPossessedBy", VT_O, {VT_O, VT_S}, &routine::getItemPossessedBy);
    routines.add("CreateItemOnObject", VT_O, {VT_S, VT_O, VT_I, VT_I}, &routine::createItemOnObject);
    routines.add("ActionEquipItem", VT_V, {VT_O, VT_I, VT_I}, &routine::actionEquipItem);
    routines.add("ActionUnequipItem", VT_V, {VT_O, VT_I}, &routine::actionUnequipItem);
    routines.add("ActionPickUpItem", VT_V, {VT_O}, &routine::actionPickUpItem);
    routines.add("ActionPutDownItem", VT_V, {VT_O}, &routine::actionPutDownItem);
    ...
    routines.add("EffectAbilityIncrease", VT_EFFECT, {VT_I, VT_I}, &routine::effectAbilityIncrease);
    routines.add("EffectDamageResistance", VT_EFFECT, {VT_I, VT_I, VT_I}, &routine::effectDamageResistance);
    routines.add("EffectResurrection", VT_EFFECT, {VT_I}, &routine::effectResurrection);
    routines.add("GetPlayerRestrictMode", VT_I, {VT_O}, &routine::getPlayerRestrictMode);
    routines.add("GetCasterLevel", VT_I, {VT_O}, &routine::getCasterLevel);
    routines.add("GetFirstEffect", VT_EFFECT, {VT_O}, &routine::getFirstEffect);
    routines.add("GetNextEffect", VT_EFFECT, {VT_O}, &routine::getNextEffect);
    ...
    routines.add("SignalEvent", VT_V, {VT_O, VT_EVENT}, &routine::signalEvent);
    routines.add("EventUserDefined", VT_EVENT, {VT_I}, &routine::eventUserDefined);
    routines.add("EffectDeath", VT_EFFECT, {VT_I, VT_I, VT_I}, &routine::effectDeath);
    routines.add("EffectKnockdown", VT_EFFECT, {}, &routine::effectKnockdown);
    routines.add("ActionGiveItem", VT_V, {VT_O, VT_O}, &routine::actionGiveItem);
    routines.add("ActionTakeItem", VT_V, {VT_O, VT_O}, &routine::actionTakeItem);
    routines.add("VectorNormalize", VT_VECTOR, {VT_VECTOR}, &routine::vectorNormalize);
    ...
    routines.add("EffectLinkEffects", VT_EFFECT, {VT_EFFECT, VT_EFFECT}, &routine::effectLinkEffects);
    routines.add("GetObjectByTag", VT_O, {VT_S, VT_I}, &routine::getObjectByTag);
    routines.add("AdjustAlignment", VT_V, {VT_O, VT_I, VT_I, VT_I}, &routine::adjustAlignment);
    routines.add("ActionWait", VT_V, {VT_F}, &routine::actionWait);
    routines.add("SetAreaTransitionBMP", VT_V, {VT_I, VT_S}, &routine::setAreaTransitionBMP);
    routines.add("ActionStartConversation", VT_V, {VT_O, VT_S, VT_I, VT_I, VT_I, VT_S, VT_S, VT_S, VT_S, VT_S, VT_S, VT_I, VT_I, VT_I, VT_I}, &routine::actionStartConversation);
    routines.add("ActionPauseConversation", VT_V, {}, &routine::actionPauseConversation);
    routines.add("ActionResumeConversation", VT_V, {}, &routine::actionResumeConversation);
    routines.add("EffectBeam", VT_EFFECT, {VT_I, VT_O, VT_I, VT_I}, &routine::effectBeam);
    routines.add("GetReputation", VT_I, {VT_O, VT_O}, &routine::getReputation);
    ...
    routines.add("GetStringByStrRef", VT_S, {VT_I}, &routine::getStringByStrRef);
    routines.add("ActionSpeakStringByStrRef", VT_V, {VT_I, VT_I}, &routine::actionSpeakStringByStrRef);
    routines.add("DestroyObject", VT_V, {VT_O, VT_F, VT_I, VT_F, VT_I}, &routine::destroyObject);
    routines.add("GetModule", VT_O, {}, &routine::getModule);
    routines.add("CreateObject", VT_O, {VT_I, VT_S, VT_LOCATION, VT_I}, &routine::createObject);
    routines.add("EventSpellCastAt", VT_EVENT, {VT_O, VT_I, VT_I}, &routine::eventSpellCastAt);
    routines.add("GetLastSpellCaster", VT_O, {}, &routine::getLastSpellCaster);
    ...
    routines.add("GetLastAttackMode", VT_I, {VT_O}, &routine::getLastAttackMode);
    routines.add("GetDistanceBetween2D", VT_F, {VT_O, VT_O}, &routine::getDistanceBetween2D);
    routines.add("GetIsInCombat", VT_I, {VT_O, VT_I}, &routine::getIsInCombat);
    routines.add("GetLastAssociateCommand", VT_I, {VT_O}, &routine::getLastAssociateCommand);
    routines.add("GiveGoldToCreature", VT_V, {VT_O, VT_I}, &routine::giveGoldToCreature);
    routines.add("SetIsDestroyable", VT_V, {VT_I, VT_I, VT_I}, &routine::setIsDestroyable);
    routines.add("SetLocked", VT_V, {VT_O, VT_I}, &routine::setLocked);
    ...
    routines.add("GetInventoryDisturbType", VT_I, {}, &routine::getInventoryDisturbType);
    routines.add("GetInventoryDisturbItem", VT_O, {}, &routine::getInventoryDisturbItem);
    routines.add("ShowUpgradeScreen", VT_V, {VT_O, VT_O, VT_I, VT_I, VT_S}, &routine::showUpgradeScreen);
    routines.add("VersusAlignmentEffect", VT_EFFECT, {VT_EFFECT, VT_I, VT_I}, &routine::versusAlignmentEffect);
    routines.add("VersusRacialTypeEffect", VT_EFFECT, {VT_EFFECT, VT_I}, &routine::versusRacialTypeEffect);
    routines.add("VersusTrapEffect", VT_EFFECT, {VT_EFFECT}, &routine::versusTrapEffect);
    routines.add("GetGender", VT_I, {VT_O}, &routine::getGender);
    ...
    routines.add("MusicBackgroundStop", VT_V, {VT_O}, &routine::musicBackgroundStop);
    routines.add("MusicBackgroundSetDelay", VT_V, {VT_O, VT_I}, &routine::musicBackgroundSetDelay);
    routines.add("MusicBackgroundChangeDay", VT_V, {VT_O, VT_I, VT_I}, &routine::musicBackgroundChangeDay);
    routines.add("MusicBackgroundChangeNight", VT_V, {VT_O, VT_I, VT_I}, &routine::musicBackgroundChangeNight);
    routines.add("MusicBattlePlay", VT_V, {VT_O}, &routine::musicBattlePlay);
    routines.add("MusicBattleStop", VT_V, {VT_O}, &routine::musicBattleStop);
    routines.add("MusicBattleChange", VT_V, {VT_O, VT_I}, &routine::musicBattleChange);
    routines.add("AmbientSoundPlay", VT_V, {VT_O}, &routine::ambientSoundPlay);
    ...
    routines.add("AddJournalWorldEntry", VT_V, {VT_I, VT_S, VT_S}, &routine::addJournalWorldEntry);
    routines.add("AddJournalWorldEntryStrref", VT_V, {VT_I, VT_I}, &routine::addJournalWorldEntryStrref);
    routines.add("BarkString", VT_V, {VT_O, VT_I, VT_I, VT_I}, &routine::barkString);
    routines.add("DeleteJournalWorldAllEntries", VT_V, {}, &routine::deleteJournalWorldAllEntries);
    routines.add("DeleteJournalWorldEntry", VT_V, {VT_I}, &routine::deleteJournalWorldEntry);
    routines.add("DeleteJournalWorldEntryStrref", VT_V, {VT_I}, &routine::deleteJournalWorldEntryStrref);
    routines.add("EffectForceDrain", VT_EFFECT, {VT_I}, &routine::effectForceDrain);
    ...
    routines.add("ClearAllEffects", VT_V, {}, &routine::clearAllEffects);
    routines.add("GetLastConversation", VT_S, {}, &routine::getLastConversation);
    routines.add("ShowPartySelectionGUI", VT_V, {VT_S, VT_I, VT_I, VT_I}, &routine::showPartySelectionGUI);
    routines.add("GetStandardFaction", VT_I, {VT_O}, &routine::getStandardFaction);
    routines.add("GivePlotXP", VT_V, {VT_S, VT_I}, &routine::givePlotXP);
    routines.add("GetMinOneHP", VT_I, {VT_O}, &routine::getMinOneHP);
    routines.add("SetMinOneHP", VT_V, {VT_O, VT_I}, &routine::setMinOneHP);
    ...
    routines.add("SetForcePowerUnsuccessful", VT_V, {VT_I, VT_O}, &routine::setForcePowerUnsuccessful);
    routines.add("GetIsDebilitated", VT_I, {VT_O}, &routine::getIsDebilitated);
    routines.add("PlayMovie", VT_V, {VT_S, VT_I}, &routine::playMovie);
    routines.add("SaveNPCState", VT_V, {VT_I}, &routine::saveNPCState);
    routines.add("GetCategoryFromTalent", VT_I, {VT_TALENT}, &routine::getCategoryFromTalent);
    routines.add("SurrenderByFaction", VT_V, {VT_I, VT_I}, &routine::surrenderByFaction);
    routines.add("ChangeFactionByFaction", VT_V, {VT_I, VT_I}, &routine::changeFactionByFaction);
    ...
    routines.add("CreateItemOnFloor", VT_O, {VT_S, VT_LOCATION, VT_I}, &routine::createItemOnFloor);
    routines.add("SetAvailableNPCId", VT_V, {VT_I, VT_O}, &routine::setAvailableNPCId);
    routines.add("GetScriptParameter", VT_I, {VT_I}, &routine::getScriptParameter);
    routines.add("SetFadeUntilScript", VT_V, {}, &routine::setFadeUntilScript);
    routines.add("EffectForceBody", VT_EFFECT, {VT_I}, &routine::effectForceBody);
    routines.add("GetItemComponent", VT_I, {}, &routine::getItemComponent);
    routines.add("GetItemComponentPieceValue", VT_I, {}, &routine::getItemComponentPieceValue);
    routines.add("ShowChemicalUpgradeScreen", VT_V, {VT_O}, &routine::showChemicalUpgradeScreen);
    routines.add("GetChemicals", VT_I, {}, &routine::getChemicals);
    routines.add("GetChemicalPieceValue", VT_I, {}, &routine::getChemicalPieceValue);
    routines.add("GetSpellForcePointCost", VT_I, {}, &routine::getSpellForcePointCost);
    routines.add("EffectFury", VT_EFFECT, {}, &routine::effectFury);
    routines.add("EffectBlind", VT_EFFECT, {}, &routine::effectBlind);
    routines.add("EffectFPRegenModifier", VT_EFFECT, {VT_I}, &routine::effectFPRegenModifier);
    routines.add("EffectVPRegenModifier", VT_EFFECT, {VT_I}, &routine::effectVPRegenModifier);
    routines.add("EffectCrush", VT_EFFECT, {}, &routine::effectCrush);

    routines.add("SWMG_GetSwoopUpgrade", VT_I, {VT_I}, &routine::minigame::getSwoopUpgrade);

    routines.add("GetFeatAcquired", VT_I, {VT_I, VT_O}, &routine::getFeatAcquired);
    routines.add("GetSpellAcquired", VT_I, {VT_I, VT_O}, &routine::getSpellAcquired);
    routines.add("ShowSwoopUpgradeScreen", VT_V, {}, &routine::showSwoopUpgradeScreen);
    routines.add("GrantFeat", VT_V, {VT_I, VT_O}, &routine::grantFeat);
    routines.add("GrantSpell", VT_V, {VT_I, VT_O}, &routine::grantSpell);
    routines.add("SpawnMine", VT_V, {VT_I, VT_LOCATION, VT_I, VT_I, VT_O}, &routine::spawnMine);

    routines.add("SWMG_GetTrackPosition", VT_VECTOR, {VT_O}, &routine::minigame::getTrackPosition);
    routines.add("SWMG_SetFollowerPosition", VT_VECTOR, {VT_VECTOR}, &routine::minigame::setFollowerPosition);

    routines.add("SetFakeCombatState", VT_V, {VT_O, VT_I}, &routine::setFakeCombatState);

    routines.add("SWMG_DestroyMiniGameObject", VT_V, {VT_O}, &routine::minigame::destroyMiniGameObject);

    routines.add("GetOwnerDemolitionsSkill", VT_I, {VT_O}, &routine::getOwnerDemolitionsSkill);
    routines.add("SetOrientOnClick", VT_V, {VT_O, VT_I}, &routine::setOrientOnClick);
    routines.add("GetInfluence", VT_I, {VT_I}, &routine::getInfluence);
    routines.add("SetInfluence", VT_V, {VT_I, VT_I}, &routine::setInfluence);
    routines.add("ModifyInfluence", VT_V, {VT_I, VT_I}, &routine::modifyInfluence);
    routines.add("GetRacialSubType", VT_I, {VT_O}, &routine::getRacialSubType);
    routines.add("IncrementGlobalNumber", VT_V, {VT_S, VT_I}, &routine::incrementGlobalNumber);
    routines.add("DecrementGlobalNumber", VT_V, {VT_S, VT_I}, &routine::decrementGlobalNumber);
    routines.add("SetBonusForcePoints", VT_V, {VT_O, VT_I}, &routine::setBonusForcePoints);
    routines.add("AddBonusForcePoints", VT_V, {VT_O, VT_I}, &routine::addBonusForcePoints);
    routines.add("GetBonusForcePoints", VT_V, {VT_O}, &routine::getBonusForcePoints);

    routines.add("SWMG_SetJumpSpeed", VT_V, {VT_F}, &routine::minigame::setJumpSpeed);

    routines.add("IsMoviePlaying", VT_I, {}, &routine::isMoviePlaying);
    routines.add("QueueMovie", VT_V, {VT_S, VT_I}, &routine::queueMovie);
    routines.add("PlayMovieQueue", VT_V, {VT_I}, &routine::playMovieQueue);
    routines.add("YavinHackDoorClose", VT_V, {VT_O}, &routine::yavinHackCloseDoor);
    routines.add("EffectDroidConfused", VT_EFFECT, {}, &routine::effectDroidConfused);
    routines.add("IsStealthed", VT_I, {VT_O}, &routine::isStealthed);
    routines.add("IsMeditating", VT_I, {VT_O}, &routine::isMeditating);
    routines.add("IsInTotalDefense", VT_I, {VT_O}, &routine::isInTotalDefense);
    routines.add("SetHealTarget", VT_V, {VT_O, VT_O}, &routine::setHealTarget);
    routines.add("GetHealTarget", VT_O, {VT_O}, &routine::getHealTarget);
    routines.add("GetRandomDestination", VT_VECTOR, {VT_O, VT_I}, &routine::getRandomDestination);
    routines.add("IsFormActive", VT_I, {VT_O, VT_I}, &routine::isFormActive);
    routines.add("GetSpellFormMask", VT_I, {VT_I}, &routine::getSpellFormMask);
    routines.add("GetSpellBaseForcePointCost", VT_I, {VT_I}, &routine::getSpellBaseForcePointCost);
    routines.add("SetKeepStealthInDialog", VT_V, {VT_I}, &routine::setKeepStealthInDialog);
    routines.add("HasLineOfSight", VT_I, {VT_VECTOR, VT_VECTOR, VT_O, VT_O}, &routine::hasLineOfSight);
    routines.add("ShowDemoScreen", VT_I, {VT_S, VT_I, VT_I, VT_I, VT_I}, &routine::showDemoScreen);
    routines.add("ForceHeartbeat", VT_V, {VT_O}, &routine::forceHeartbeat);
    routines.add("EffectForceSight", VT_EFFECT, {}, &routine::effectForceSight);
    routines.add("IsRunning", VT_I, {VT_O}, &routine::isRunning);

    routines.add("SWMG_PlayerApplyForce", VT_V, {VT_VECTOR}, &routine::minigame::playerApplyForce);

    routines.add("SetForfeitConditions", VT_V, {VT_I}, &routine::setForfeitConditions);
    routines.add("GetLastForfeitViolation", VT_I, {}, &routine::getLastForfeitViolation);
    routines.add("ModifyReflexSavingThrowBase", VT_V, {VT_O, VT_I}, &routine::modifyReflexSavingThrowBase);
    routines.add("ModifyFortitudeSavingThrowBase", VT_V, {VT_O, VT_I}, &routine::modifyFortitudeSavingThrowBase);
    routines.add("ModifyWillSavingThrowBase", VT_V, {VT_O, VT_I}, &routine::modifyWillSavingThrowBase);
    routines.add("GetScriptStringParameter", VT_S, {}, &routine::getScriptStringParameter);
    routines.add("GetObjectPersonalSpace", VT_F, {VT_O}, &routine::getObjectPersonalSpace);
    routines.add("AdjustCreatureAttributes", VT_V, {VT_O, VT_I, VT_I}, &routine::adjustCreatureAttributes);
    routines.add("SetCreatureAILevel", VT_V, {VT_O, VT_I}, &routine::setCreatureAILevel);
    routines.add("ResetCreatureAILevel", VT_V, {VT_O}, &routine::resetCreatureAILevel);
    routines.add("AddAvailablePUPByTemplate", VT_I, {VT_I, VT_S}, &routine::addAvailablePUPByTemplate);
    routines.add("AddAvailablePUPByObject", VT_I, {VT_I, VT_O}, &routine::addAvailablePUPByObject);
    routines.add("AssignPUP", VT_I, {VT_I, VT_I}, &routine::assignPUP);
    routines.add("SpawnAvailablePUP", VT_O, {VT_I, VT_LOCATION}, &routine::spawnAvailablePUP);
    routines.add("AddPartyPuppet", VT_I, {VT_I, VT_O}, &routine::addPartyPuppet);
    routines.add("GetPUPOwner", VT_O, {VT_O}, &routine::getPUPOwner);
    routines.add("GetIsPuppet", VT_I, {VT_O}, &routine::getIsPuppet);
    routines.add("ActionFollowOwner", VT_V, {VT_F}, &routine::actionFollowOwner);
    routines.add("GetIsPartyLeader", VT_I, {VT_O}, &routine::getIsPartyLeader);
    routines.add("GetPartyLeader", VT_O, {}, &routine::getPartyLeader);
    routines.add("RemoveNPCFromPartyToBase", VT_I, {VT_I}, &routine::removeNPCFromPartyToBase);
    routines.add("CreatureFlourishWeapon", VT_V, {VT_O}, &routine::creatureFlourishWeapon);
    routines.add("EffectMindTrick", VT_EFFECT, {}, &routine::effectMindTrick);
    routines.add("EffectFactionModifier", VT_EFFECT, {VT_I}, &routine::effectFactionModifier);
    routines.add("ChangeObjectAppearance", VT_V, {VT_O, VT_I}, &routine::changeObjectAppearance);
    routines.add("GetIsXBox", VT_I, {}, &routine::getIsXBox);
    routines.add("EffectDroidScramble", VT_EFFECT, {}, &routine::effectDroidScramble);
    routines.add("ActionSwitchWeapons", VT_V, {}, &routine::actionSwitchWeapons);
    routines.add("PlayOverlayAnimation", VT_V, {VT_O, VT_I}, &routine::playOverlayAnimation);
    routines.add("UnlockAllSongs", VT_V, {}, &routine::unlockAllSongs);
    routines.add("DisableMap", VT_V, {VT_I}, &routine::disableMap);
    routines.add("DetonateMine", VT_V, {VT_O}, &routine::detonateMine);
    routines.add("DisableHealthRegen", VT_V, {VT_I}, &routine::disableHealthRegen);
    routines.add("SetCurrentForm", VT_V, {VT_O, VT_I}, &routine::setCurrentForm);
    routines.add("SetDisableTransit", VT_V, {VT_I}, &routine::setDisableTransit);
    routines.add("SetInputClass", VT_V, {VT_I}, &routine::setInputClass);
    routines.add("SetForceAlwaysUpdate", VT_V, {VT_O, VT_I}, &routine::setForceAlwaysUpdate);
    routines.add("EnableRain", VT_V, {VT_I}, &routine::enableRain);
    routines.add("DisplayMessageBox", VT_V, {VT_I, VT_S}, &routine::displayMessageBox);
    routines.add("DisplayDatapad", VT_V, {VT_O}, &routine::displayDatapad);
    routines.add("RemoveHeartbeat", VT_V, {VT_O}, &routine::removeHeartbeat);
    routines.add("RemoveEffectByID", VT_V, {VT_O, VT_I}, &routine::removeEffectByID);
    routines.add("RemoveEffectByExactMatch", VT_V, {VT_O, VT_EFFECT}, &routine::removeEffectByExactMatch);
    routines.add("AdjustCreatureSkills", VT_V, {VT_O, VT_I, VT_I}, &routine::adjustCreatureSkills);
    routines.add("GetSkillRankBase", VT_I, {VT_I, VT_O}, &routine::getSkillRankBase);
    routines.add("EnableRendering", VT_V, {VT_O, VT_I}, &routine::enableRendering);
    routines.add("GetCombatActionsPending", VT_I, {VT_O}, &routine::getCombatActionsPending);
    routines.add("SaveNPCByObject", VT_V, {VT_I, VT_O}, &routine::saveNPCByObject);
