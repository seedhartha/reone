...
REO_DECL_ROUTINE(setLateralAccelerationPerSecond)
REO_DECL_ROUTINE(getLateralAccelerationPerSecond)
REO_DECL_ROUTINE(setSpeedBlurEffect)
REO_DECL_ROUTINE(getLastEvent)
REO_DECL_ROUTINE(getLastEventModelName)
REO_DECL_ROUTINE(getObjectByName)
REO_DECL_ROUTINE(playAnimation)
REO_DECL_ROUTINE(getLastBulletHitDamage)
REO_DECL_ROUTINE(getLastBulletHitTarget)
REO_DECL_ROUTINE(getLastBulletHitShooter)
REO_DECL_ROUTINE(adjustFollowerHitPoints)
REO_DECL_ROUTINE(onBulletHit)
REO_DECL_ROUTINE(onObstacleHit)
REO_DECL_ROUTINE(getLastFollowerHit)
REO_DECL_ROUTINE(getLastObstacleHit)
REO_DECL_ROUTINE(getLastBulletFiredDamage)
REO_DECL_ROUTINE(getLastBulletFiredTarget)
REO_DECL_ROUTINE(getObjectName)
REO_DECL_ROUTINE(onDeath)
REO_DECL_ROUTINE(isFollower)
REO_DECL_ROUTINE(isPlayer)
REO_DECL_ROUTINE(isEnemy)
REO_DECL_ROUTINE(isTrigger)
REO_DECL_ROUTINE(isObstacle)
REO_DECL_ROUTINE(setFollowerHitPoints)
REO_DECL_ROUTINE(onDamage)
REO_DECL_ROUTINE(getLastHPChange)
REO_DECL_ROUTINE(removeAnimation)
REO_DECL_ROUTINE(getCameraNearClip)
REO_DECL_ROUTINE(getCameraFarClip)
REO_DECL_ROUTINE(setCameraClip)
REO_DECL_ROUTINE(getPlayer)
REO_DECL_ROUTINE(getEnemyCount)
REO_DECL_ROUTINE(getEnemy)
REO_DECL_ROUTINE(getObstacleCount)
REO_DECL_ROUTINE(getObstacle)
REO_DECL_ROUTINE(getHitPoints)
REO_DECL_ROUTINE(getMaxHitPoints)
REO_DECL_ROUTINE(setMaxHitPoints)
REO_DECL_ROUTINE(getSphereRadius)
REO_DECL_ROUTINE(setSphereRadius)
REO_DECL_ROUTINE(getNumLoops)
REO_DECL_ROUTINE(setNumLoops)
REO_DECL_ROUTINE(getPosition)
REO_DECL_ROUTINE(getGunBankCount)
REO_DECL_ROUTINE(getGunBankBulletModel)
REO_DECL_ROUTINE(getGunBankGunModel)
REO_DECL_ROUTINE(getGunBankDamage)
REO_DECL_ROUTINE(getGunBankTimeBetweenShots)
REO_DECL_ROUTINE(getGunBankLifespan)
REO_DECL_ROUTINE(getGunBankSpeed)
REO_DECL_ROUTINE(getGunBankTarget)
REO_DECL_ROUTINE(setGunBankBulletModel)
REO_DECL_ROUTINE(setGunBankGunModel)
REO_DECL_ROUTINE(setGunBankDamage)
REO_DECL_ROUTINE(setGunBankTimeBetweenShots)
REO_DECL_ROUTINE(setGunBankLifespan)
REO_DECL_ROUTINE(setGunBankSpeed)
REO_DECL_ROUTINE(setGunBankTarget)
REO_DECL_ROUTINE(getLastBulletHitPart)
REO_DECL_ROUTINE(isGunBankTargetting)
REO_DECL_ROUTINE(getPlayerOffset)
REO_DECL_ROUTINE(getPlayerInvincibility)
REO_DECL_ROUTINE(getPlayerSpeed)
REO_DECL_ROUTINE(getPlayerMinSpeed)
REO_DECL_ROUTINE(getPlayerAccelerationPerSecond)
REO_DECL_ROUTINE(getPlayerTunnelPos)
REO_DECL_ROUTINE(setPlayerOffset)
REO_DECL_ROUTINE(setPlayerInvincibility)
REO_DECL_ROUTINE(setPlayerSpeed)
REO_DECL_ROUTINE(setPlayerMinSpeed)
REO_DECL_ROUTINE(setPlayerAccelerationPerSecond)
REO_DECL_ROUTINE(setPlayerTunnelPos)
REO_DECL_ROUTINE(getPlayerTunnelNeg)
REO_DECL_ROUTINE(setPlayerTunnelNeg)
REO_DECL_ROUTINE(getPlayerOrigin)
REO_DECL_ROUTINE(setPlayerOrigin)
REO_DECL_ROUTINE(getGunBankHorizontalSpread)
REO_DECL_ROUTINE(getGunBankVerticalSpread)
REO_DECL_ROUTINE(getGunBankSensingRadius)
REO_DECL_ROUTINE(getGunBankInaccuracy)
REO_DECL_ROUTINE(setGunBankHorizontalSpread)
REO_DECL_ROUTINE(setGunBankVerticalSpread)
REO_DECL_ROUTINE(setGunBankSensingRadius)
REO_DECL_ROUTINE(setGunBankInaccuracy)
REO_DECL_ROUTINE(getIsInvulnerable)
REO_DECL_ROUTINE(startInvulnerability)
REO_DECL_ROUTINE(getPlayerMaxSpeed)
REO_DECL_ROUTINE(setPlayerMaxSpeed)
REO_DECL_ROUTINE(getSoundFrequency)
REO_DECL_ROUTINE(setSoundFrequency)
REO_DECL_ROUTINE(getSoundFrequencyIsRandom)
REO_DECL_ROUTINE(setSoundFrequencyIsRandom)
REO_DECL_ROUTINE(getSoundVolume)
REO_DECL_ROUTINE(setSoundVolume)
REO_DECL_ROUTINE(getPlayerTunnelInfinite)
REO_DECL_ROUTINE(setPlayerTunnelInfinite)
REO_DECL_ROUTINE(getSwoopUpgrade)
REO_DECL_ROUTINE(getTrackPosition)
REO_DECL_ROUTINE(setFollowerPosition)
REO_DECL_ROUTINE(destroyMiniGameObject)
REO_DECL_ROUTINE(setJumpSpeed)
REO_DECL_ROUTINE(playerApplyForce)
