...
bool getBool(const std::vector<script::Variable> &args, int index, bool defValue = false);
int getInt(const std::vector<script::Variable> &args, int index, int defValue = 0);
float getFloat(const std::vector<script::Variable> &args, int index, float defValue = 0.0f);
std::string getString(const std::vector<script::Variable> &args, int index, std::string defValue = "");
glm::vec3 getVector(const std::vector<script::Variable> &args, int index, glm::vec3 defValue = glm::vec3(0.0f));
