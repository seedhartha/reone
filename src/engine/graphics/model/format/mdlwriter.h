...
private:
    ...
    void writeModelHeader(int numNodes, uint32_t offRootNode, StreamWriter &mdl);
    ...
    void writeNodes(uint32_t offNodes, uint32_t offParent, ModelNode &node, StreamWriter &mdl, StreamWriter &mdx, int &dfsIdx);
    void writeMesh(const ModelNode::TriangleMesh &mesh, StreamWriter &mdl, StreamWriter &mdx);
