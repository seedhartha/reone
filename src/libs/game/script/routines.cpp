...
void Routines::initForKotOR() {
    ...
    add("PrintFloat", R_VOID, {R_FLOAT, R_INT, R_INT}, &routine::notImplemented);
    add("FloatToString", R_STRING, {R_FLOAT, R_INT, R_INT}, &routine::floatToString);
    add("PrintInteger", R_VOID, {R_INT}, &routine::notImplemented);
    add("PrintObject", R_VOID, {R_OBJECT}, &routine::notImplemented);
    ...
    add("SetTime", R_VOID, {R_INT, R_INT, R_INT, R_INT}, &routine::notImplemented);
    ...
    add("GetTimeHour", R_INT, {}, &routine::notImplemented);
    add("GetTimeMinute", R_INT, {}, &routine::notImplemented);
    add("GetTimeSecond", R_INT, {}, &routine::notImplemented);
    add("GetTimeMillisecond", R_INT, {}, &routine::notImplemented);
    ...
    add("ActionPickUpItem", R_VOID, {R_OBJECT}, &routine::notImplemented);
    add("ActionPutDownItem", R_VOID, {R_OBJECT}, &routine::notImplemented);
    ...
    add("ActionSpeakString", R_VOID, {R_STRING, R_INT}, &routine::notImplemented);
    ...
    add("SetCameraFacing", R_VOID, {R_FLOAT}, &routine::notImplemented);
    ...
    add("GetLastItemEquipped", R_OBJECT, {}, &routine::notImplemented);
    ...
    add("GetStringUpperCase", R_STRING, {R_STRING}, &routine::notImplemented);
    add("GetStringLowerCase", R_STRING, {R_STRING}, &routine::notImplemented);
    ...
    add("InsertString", R_STRING, {R_STRING, R_STRING, R_INT}, &routine::notImplemented);
    ...
    add("fabs", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("cos", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("sin", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("tan", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("acos", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("asin", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("atan", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("log", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("pow", R_FLOAT, {R_FLOAT, R_FLOAT}, &routine::notImplemented);
    add("sqrt", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    ...
    add("GetEffectDurationType", R_INT, {R_EFFECT}, &routine::notImplemented);
    add("GetEffectSubType", R_INT, {R_EFFECT}, &routine::notImplemented);
    ...
    add("VectorMagnitude", R_FLOAT, {R_VECTOR}, &routine::notImplemented);
    ...
    add("MagicalEffect", R_EFFECT, {R_EFFECT}, &routine::notImplemented);
    add("SupernaturalEffect", R_EFFECT, {R_EFFECT}, &routine::notImplemented);
    add("ExtraordinaryEffect", R_EFFECT, {R_EFFECT}, &routine::notImplemented);
    add("EffectACIncrease", R_EFFECT, {R_INT, R_INT, R_INT}, &routine::effectACIncrease);
    add("GetAC", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("EffectDamageReduction", R_EFFECT, {R_INT, R_INT, R_INT}, &routine::notImplemented);
    ...
    add("TurnsToSeconds", R_FLOAT, {R_INT}, &routine::notImplemented);
    ...
    add("EffectKnockdown", R_EFFECT, {}, &routine::notImplemented);
    ...
    add("PrintVector", R_VOID, {R_VECTOR, R_INT}, &routine::notImplemented);
    ...
    add("VectorToAngle", R_FLOAT, {R_VECTOR}, &routine::notImplemented);
    add("TouchAttackMelee", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("TouchAttackRanged", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("EffectParalyze", R_EFFECT, {}, &routine::effectParalyze);
    add("EffectSpellImmunity", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("EffectForceJump", R_EFFECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("EffectConfused", R_EFFECT, {}, &routine::notImplemented);
    add("EffectFrightened", R_EFFECT, {}, &routine::notImplemented);
    ...
    add("ActionForceFollowObject", R_VOID, {R_OBJECT, R_FLOAT}, &routine::notImplemented);
    ...
    add("EffectAreaOfEffect", R_EFFECT, {R_INT, R_STRING, R_STRING, R_STRING}, &routine::notImplemented);
    add("GetFactionEqual", R_INT, {R_OBJECT, R_OBJECT}, &routine::getFactionEqual);
    add("ChangeFaction", R_VOID, {R_OBJECT, R_OBJECT}, &routine::notImplemented);
    add("GetIsListening", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("TestStringAgainstPattern", R_INT, {R_STRING, R_STRING}, &routine::notImplemented);
    add("GetMatchedSubstring", R_STRING, {R_INT}, &routine::notImplemented);
    add("GetMatchedSubstringsCount", R_INT, {}, &routine::notImplemented);
    add("EffectVisualEffect", R_EFFECT, {R_INT, R_INT}, &routine::effectVisualEffect);
    add("GetFactionWeakestMember", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetFactionStrongestMember", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetFactionMostDamagedMember", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetFactionLeastDamagedMember", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetFactionGold", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetFactionAverageReputation", R_INT, {R_OBJECT, R_OBJECT}, &routine::getFactionAverageReputation, Variable::ofInt(-1));
    add("GetFactionAverageGoodEvilAlignment", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SoundObjectGetFixedVariance", R_FLOAT, {R_OBJECT}, &routine::notImplemented);
    add("GetFactionAverageLevel", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetFactionAverageXP", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetFactionMostFrequentClass", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetFactionWorstAC", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetFactionBestAC", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("GetTransitionTarget", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("SetAreaTransitionBMP", R_VOID, {R_INT, R_STRING}, &routine::notImplemented);
    ...
    add("GetGoingToBeAttackedBy", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("FeetToMeters", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    add("YardsToMeters", R_FLOAT, {R_FLOAT}, &routine::notImplemented);
    ...
    add("GetNearestCreatureToLocation", R_OBJECT, {R_INT, R_INT, R_LOCATION, R_INT, R_INT, R_INT, R_INT, R_INT}, &routine::notImplemented);
    add("GetNearestObject", R_OBJECT, {R_INT, R_OBJECT, R_INT}, &routine::getNearestObject);
    add("GetNearestObjectToLocation", R_OBJECT, {R_INT, R_LOCATION, R_INT}, &routine::notImplemented);
    ...
    add("StringToFloat", R_FLOAT, {R_STRING}, &routine::notImplemented);
    add("ActionCastSpellAtLocation", R_VOID, {R_INT, R_LOCATION, R_INT, R_INT, R_INT, R_INT}, &routine::notImplemented);
    ...
    add("ActionSpeakStringByStrRef", R_VOID, {R_INT, R_INT}, &routine::notImplemented);
    ...
    add("RandomName", R_STRING, {}, &routine::notImplemented);
    add("EffectPoison", R_EFFECT, {R_INT}, &routine::effectPoison);
    add("GetLoadFromSaveGame", R_INT, {}, &routine::getLoadFromSaveGame);
    add("EffectAssuredDeflection", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("GetLastPerceptionHeard", R_INT, {}, &routine::notImplemented);
    add("GetLastPerceptionInaudible", R_INT, {}, &routine::notImplemented);
    ...
    add("GetAreaOfEffectCreator", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetButtonMashCheck", R_INT, {}, &routine::notImplemented);
    ...
    add("EffectHaste", R_EFFECT, {}, &routine::notImplemented);
    ...
    add("GetEncounterSpawnsMax", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SetEncounterSpawnsMax", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
    add("GetEncounterSpawnsCurrent", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SetEncounterSpawnsCurrent", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
    add("GetModuleItemAcquired", R_OBJECT, {}, &routine::getModuleItemAcquired);
    add("GetModuleItemAcquiredFrom", R_OBJECT, {}, &routine::notImplemented);
    ...
    add("ActionUseFeat", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
    ...
    add("GetObjectHeard", R_INT, {R_OBJECT, R_OBJECT}, &routine::notImplemented);
    add("GetLastPlayerDied", R_OBJECT, {}, &routine::getLastPlayerDied);
    add("GetModuleItemLost", R_OBJECT, {}, &routine::notImplemented);
    add("GetModuleItemLostBy", R_OBJECT, {}, &routine::notImplemented);
    add("ActionDoCommand", R_VOID, {R_ACTION}, &routine::actionDoCommand);
    add("EventConversation", R_EVENT, {}, &routine::notImplemented);
    add("SetEncounterDifficulty", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
    add("GetEncounterDifficulty", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetDistanceBetweenLocations", R_FLOAT, {R_LOCATION, R_LOCATION}, &routine::notImplemented);
    ...
    add("TalentSkill", R_TALENT, {R_INT}, &routine::notImplemented);
    ...
    add("ActionUseTalentAtLocation", R_VOID, {R_TALENT, R_LOCATION}, &routine::notImplemented);
    add("GetGoldPieceValue", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetIsPlayableRacialType", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetLastAttackType", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetLastAttackMode", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetLastAssociateCommand", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetClickingObject", R_OBJECT, {}, &routine::notImplemented);
    add("SetAssociateListenPatterns", R_VOID, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetIdentified", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SetIdentified", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetDistanceBetweenLocations2D", R_FLOAT, {R_LOCATION, R_LOCATION}, &routine::notImplemented);
    ...
    add("GetLastDisarmed", R_OBJECT, {}, &routine::notImplemented);
    add("GetLastDisturbed", R_OBJECT, {}, &routine::notImplemented);
    add("GetLastLocked", R_OBJECT, {}, &routine::notImplemented);
    add("GetLastUnlocked", R_OBJECT, {}, &routine::notImplemented);
    ...
    add("VersusAlignmentEffect", R_EFFECT, {R_EFFECT, R_INT, R_INT}, &routine::notImplemented);
    add("VersusRacialTypeEffect", R_EFFECT, {R_EFFECT, R_INT}, &routine::notImplemented);
    add("VersusTrapEffect", R_EFFECT, {R_EFFECT}, &routine::notImplemented);
    add("GetGender", R_INT, {R_OBJECT}, &routine::getGender);
    add("GetIsTalentValid", R_INT, {R_TALENT}, &routine::getIsTalentValid);
    add("ActionMoveAwayFromLocation", R_VOID, {R_LOCATION, R_INT, R_FLOAT}, &routine::notImplemented);
    ...
    add("SendMessageToPC", R_VOID, {R_OBJECT, R_STRING}, &routine::notImplemented);
    ...
    add("GetFirstFactionMember", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetNextFactionMember", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("GetJournalQuestExperience", R_INT, {R_STRING}, &routine::notImplemented);
    ...
    add("EffectHitPointChangeWhenDying", R_EFFECT, {R_FLOAT}, &routine::notImplemented);
    add("PopUpGUIPanel", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("IntToHexString", R_STRING, {R_INT}, &routine::notImplemented);
    ...
    add("GetItemACValue", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("EffectForceResisted", R_EFFECT, {R_OBJECT}, &routine::effectForceResisted);
    add("ExploreAreaForPlayer", R_VOID, {R_OBJECT, R_OBJECT}, &routine::notImplemented);
    add("ActionEquipMostEffectiveArmor", R_VOID, {}, &routine::notImplemented);
    add("GetIsDay", R_INT, {}, &routine::notImplemented);
    add("GetIsNight", R_INT, {}, &routine::notImplemented);
    add("GetIsDawn", R_INT, {}, &routine::notImplemented);
    add("GetIsDusk", R_INT, {}, &routine::notImplemented);
    add("GetIsEncounterCreature", R_INT, {R_OBJECT}, &routine::getIsEncounterCreature);
    add("GetLastPlayerDying", R_OBJECT, {}, &routine::notImplemented);
    add("GetStartingLocation", R_LOCATION, {}, &routine::notImplemented);
    ...
    add("SpeakOneLinerConversation", R_VOID, {R_STRING, R_OBJECT}, &routine::notImplemented);
    add("GetGold", R_INT, {R_OBJECT}, &routine::getGold);
    add("GetLastRespawnButtonPresser", R_OBJECT, {}, &routine::notImplemented);
    ...
    add("GetIsWeaponEffective", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetLastSpellHarmful", R_INT, {}, &routine::getLastSpellHarmful);
    add("EventActivateItem", R_EVENT, {R_OBJECT, R_LOCATION, R_OBJECT}, &routine::notImplemented);
    ...
    add("MusicBackgroundSetDelay", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("MusicBattleChange", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("AmbientSoundChangeDay", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("AmbientSoundChangeNight", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetLastKiller", R_OBJECT, {}, &routine::getLastKiller);
    add("GetSpellCastItem", R_OBJECT, {}, &routine::notImplemented);
    add("GetItemActivated", R_OBJECT, {}, &routine::getItemActivated);
    add("GetItemActivator", R_OBJECT, {}, &routine::getItemActivator);
    add("GetItemActivatedTargetLocation", R_LOCATION, {}, &routine::notImplemented);
    add("GetItemActivatedTarget", R_OBJECT, {}, &routine::notImplemented);
    ...
    add("EffectDamageImmunityDecrease", R_EFFECT, {R_INT, R_INT}, &routine::notImplemented);
    ...
    add("EffectSkillDecrease", R_EFFECT, {R_INT, R_INT}, &routine::notImplemented);
    add("EffectForceResistanceDecrease", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("EffectConcealment", R_EFFECT, {R_INT}, &routine::notImplemented);
    add("EffectForceShield", R_EFFECT, {R_INT}, &routine::effectForceShield);
    add("EffectDispelMagicAll", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("GetMaxStealthXP", R_INT, {}, &routine::notImplemented);
    add("EffectTrueSeeing", R_EFFECT, {}, &routine::effectTrueSeeing);
    add("EffectSeeInvisible", R_EFFECT, {}, &routine::notImplemented);
    add("EffectTimeStop", R_EFFECT, {}, &routine::notImplemented);
    ...
    add("EffectBlasterDeflectionDecrease", R_EFFECT, {R_INT}, &routine::notImplemented);
    add("EffectHorrified", R_EFFECT, {}, &routine::effectHorrified);
    add("EffectSpellLevelAbsorption", R_EFFECT, {R_INT, R_INT, R_INT}, &routine::notImplemented);
    add("EffectDispelMagicBest", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("EffectMissChance", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("GetStealthXPEnabled", R_INT, {}, &routine::notImplemented);
    ...
    add("GetLastTrapDetected", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    add("EffectDamageShield", R_EFFECT, {R_INT, R_INT, R_INT}, &routine::notImplemented);
    add("GetNearestTrapToObject", R_OBJECT, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("GetFortitudeSavingThrow", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetWillSavingThrow", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetReflexSavingThrow", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetMovementRate", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetSubRace", R_INT, {R_OBJECT}, &routine::getSubRace, Variable::ofInt(static_cast<int>(Subrace::None)));
    add("GetStealthXPDecrement", R_INT, {}, &routine::notImplemented);
    add("SetStealthXPDecrement", R_VOID, {R_INT}, &routine::notImplemented);
    ...
    add("SetCameraMode", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("CutsceneMove", R_VOID, {R_OBJECT, R_VECTOR, R_INT}, &routine::notImplemented);
    ...
    add("GetWeaponRanged", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("SetTutorialWindowsEnabled", R_VOID, {R_INT}, &routine::notImplemented);
    ...
    add("SWMG_GetLateralAccelerationPerSecond", R_FLOAT, {}, &routine::notImplemented);

    add("GetCurrentAction", R_INT, {R_OBJECT}, &routine::getCurrentAction);
    add("GetDifficultyModifier", R_FLOAT, {}, &routine::notImplemented);
    add("GetAppearanceType", R_INT, {R_OBJECT}, &routine::getAppearanceType);
    add("FloatingTextStrRefOnCreature", R_VOID, {R_INT, R_OBJECT, R_INT}, &routine::notImplemented);
    add("FloatingTextStringOnCreature", R_VOID, {R_STRING, R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetTrapDisarmable", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapDetectable", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapDetectedBy", R_INT, {R_OBJECT, R_OBJECT}, &routine::notImplemented);
    add("GetTrapFlagged", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapBaseType", R_INT, {R_OBJECT}, &routine::getTrapBaseType);
    add("GetTrapOneShot", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapCreator", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapKeyTag", R_STRING, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapDisarmDC", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetTrapDetectDC", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetLockKeyRequired", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetLockKeyTag", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetLockLockable", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetLockUnlockDC", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetLockLockDC", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetPCLevellingUp", R_OBJECT, {}, &routine::notImplemented);
    add("GetHasFeatEffect", R_INT, {R_INT, R_OBJECT}, &routine::notImplemented);
    add("SetPlaceableIllumination", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("GetPlaceableIllumination", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("GetIsPlaceableObjectActionPossible", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("DoPlaceableObjectAction", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("PopUpDeathGUIPanel", R_VOID, {R_OBJECT, R_INT, R_INT, R_INT, R_STRING}, &routine::notImplemented);
    add("SetTrapDisabled", R_VOID, {R_OBJECT}, &routine::notImplemented);
    add("GetLastHostileActor", R_OBJECT, {R_OBJECT}, &routine::getLastHostileActor);
    add("ExportAllCharacters", R_VOID, {}, &routine::notImplemented);
    add("MusicBackgroundGetDayTrack", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("MusicBackgroundGetNightTrack", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("WriteTimestampedLogEntry", R_VOID, {R_STRING}, &routine::notImplemented);
    add("GetModuleName", R_STRING, {}, &routine::getModuleName);
    add("GetFactionLeader", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("AmbientSoundSetDayVolume", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("AmbientSoundSetNightVolume", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("GetStrRefSoundDuration", R_FLOAT, {R_INT}, &routine::notImplemented);
    ...
    add("SWMG_GetLastEvent", R_STRING, {}, &routine::notImplemented);
    add("SWMG_GetLastEventModelName", R_STRING, {}, &routine::notImplemented);
    add("SWMG_GetObjectByName", R_OBJECT, {R_STRING}, &routine::notImplemented);
    add("SWMG_PlayAnimation", R_VOID, {R_OBJECT, R_STRING, R_INT, R_INT, R_INT}, &routine::minigame::playAnimation);
    add("SWMG_GetLastBulletHitDamage", R_INT, {}, &routine::notImplemented);
    add("SWMG_GetLastBulletHitTarget", R_INT, {}, &routine::notImplemented);
    add("SWMG_GetLastBulletHitShooter", R_OBJECT, {}, &routine::notImplemented);
    add("SWMG_AdjustFollowerHitPoints", R_INT, {R_OBJECT, R_INT, R_INT}, &routine::minigame::adjustFollowerHitPoints);
    add("SWMG_OnBulletHit", R_VOID, {}, &routine::notImplemented);
    add("SWMG_OnObstacleHit", R_VOID, {}, &routine::notImplemented);
    ...
    add("SWMG_GetLastBulletFiredDamage", R_INT, {}, &routine::notImplemented);
    add("SWMG_GetLastBulletFiredTarget", R_INT, {}, &routine::notImplemented);
    add("SWMG_GetObjectName", R_STRING, {R_OBJECT}, &routine::minigame::getObjectName);
    add("SWMG_OnDeath", R_VOID, {}, &routine::minigame::onDeath);
    add("SWMG_IsFollower", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SWMG_IsPlayer", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SWMG_IsEnemy", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SWMG_IsTrigger", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SWMG_IsObstacle", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("SWMG_GetLastHPChange", R_INT, {}, &routine::notImplemented);
    add("SWMG_RemoveAnimation", R_VOID, {R_OBJECT, R_STRING}, &routine::minigame::removeAnimation);
    add("SWMG_GetCameraNearClip", R_FLOAT, {}, &routine::notImplemented);
    add("SWMG_GetCameraFarClip", R_FLOAT, {}, &routine::notImplemented);
    add("SWMG_SetCameraClip", R_VOID, {R_FLOAT, R_FLOAT}, &routine::notImplemented);
    ...
    add("SWMG_GetObstacleCount", R_INT, {}, &routine::notImplemented);
    add("SWMG_GetObstacle", R_OBJECT, {R_INT}, &routine::notImplemented);
    ...
    add("SWMG_SetMaxHitPoints", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetSphereRadius", R_FLOAT, {R_OBJECT}, &routine::minigame::getSphereRadius);
    add("SWMG_SetSphereRadius", R_VOID, {R_OBJECT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_GetNumLoops", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SWMG_SetNumLoops", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetPosition", R_VECTOR, {R_OBJECT}, &routine::minigame::getPosition);
    add("SWMG_GetGunBankCount", R_INT, {R_OBJECT}, &routine::notImplemented);
    add("SWMG_GetGunBankBulletModel", R_STRING, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankGunModel", R_STRING, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankDamage", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankTimeBetweenShots", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankLifespan", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankSpeed", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankTarget", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_SetGunBankBulletModel", R_VOID, {R_OBJECT, R_INT, R_STRING}, &routine::notImplemented);
    add("SWMG_SetGunBankGunModel", R_VOID, {R_OBJECT, R_INT, R_STRING}, &routine::notImplemented);
    add("SWMG_SetGunBankDamage", R_VOID, {R_OBJECT, R_INT, R_INT}, &routine::notImplemented);
    add("SWMG_SetGunBankTimeBetweenShots", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_SetGunBankLifespan", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_SetGunBankSpeed", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_SetGunBankTarget", R_VOID, {R_OBJECT, R_INT, R_INT}, &routine::notImplemented);
    add("SWMG_GetLastBulletHitPart", R_STRING, {}, &routine::notImplemented);
    add("SWMG_IsGunBankTargetting", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetPlayerOffset", R_VECTOR, {}, &routine::minigame::getPlayerOffset);
    add("SWMG_GetPlayerInvincibility", R_FLOAT, {}, &routine::notImplemented);
    ...
    add("SWMG_GetPlayerTunnelPos", R_VECTOR, {}, &routine::notImplemented);
    add("SWMG_SetPlayerOffset", R_VOID, {R_VECTOR}, &routine::notImplemented);
    ...
    add("SWMG_GetPlayerTunnelNeg", R_VECTOR, {}, &routine::notImplemented);
    add("SWMG_SetPlayerTunnelNeg", R_VOID, {R_VECTOR}, &routine::minigame::setPlayerTunnelNeg);
    add("SWMG_GetPlayerOrigin", R_VECTOR, {}, &routine::notImplemented);
    add("SWMG_SetPlayerOrigin", R_VOID, {R_VECTOR}, &routine::notImplemented);
    add("SWMG_GetGunBankHorizontalSpread", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankVerticalSpread", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankSensingRadius", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_GetGunBankInaccuracy", R_FLOAT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_SetGunBankHorizontalSpread", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_SetGunBankVerticalSpread", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_SetGunBankSensingRadius", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    add("SWMG_SetGunBankInaccuracy", R_VOID, {R_OBJECT, R_INT, R_FLOAT}, &routine::notImplemented);
    ...
    add("SWMG_GetPlayerMaxSpeed", R_FLOAT, {}, &routine::notImplemented);
    add("SWMG_SetPlayerMaxSpeed", R_VOID, {R_FLOAT}, &routine::minigame::setPlayerMaxSpeed);

    add("AddJournalWorldEntry", R_VOID, {R_INT, R_STRING, R_STRING}, &routine::notImplemented);
    add("AddJournalWorldEntryStrref", R_VOID, {R_INT, R_INT}, &routine::notImplemented);
    add("BarkString", R_VOID, {R_OBJECT, R_INT}, &routine::barkString);
    add("DeleteJournalWorldAllEntries", R_VOID, {}, &routine::notImplemented);
    add("DeleteJournalWorldEntry", R_VOID, {R_INT}, &routine::notImplemented);
    add("DeleteJournalWorldEntryStrref", R_VOID, {R_INT}, &routine::notImplemented);
    add("EffectForceDrain", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("SetJournalQuestEntryPicture", R_VOID, {R_STRING, R_OBJECT, R_INT, R_INT, R_INT}, &routine::notImplemented);
    ...
    add("SWMG_GetSoundFrequency", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_SetSoundFrequency", R_VOID, {R_OBJECT, R_INT, R_INT}, &routine::notImplemented);
    add("SWMG_GetSoundFrequencyIsRandom", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_SetSoundFrequencyIsRandom", R_VOID, {R_OBJECT, R_INT, R_INT}, &routine::notImplemented);
    add("SWMG_GetSoundVolume", R_INT, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("SWMG_SetSoundVolume", R_VOID, {R_OBJECT, R_INT, R_INT}, &routine::notImplemented);

    add("SoundObjectGetPitchVariance", R_FLOAT, {R_OBJECT}, &routine::soundObjectGetPitchVariance);
    add("SoundObjectSetPitchVariance", R_VOID, {R_OBJECT, R_FLOAT}, &routine::notImplemented);
    add("SoundObjectGetVolume", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("SetPartyAIStyle", R_VOID, {R_INT}, &routine::notImplemented);
    ...
    add("GetLastConversation", R_STRING, {}, &routine::notImplemented);
    ...
    add("SWMG_GetPlayerTunnelInfinite", R_VECTOR, {}, &routine::notImplemented);
    add("SWMG_SetPlayerTunnelInfinite", R_VOID, {R_VECTOR}, &routine::notImplemented);
    ...
    add("GetFirstAttacker", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    add("GetNextAttacker", R_OBJECT, {R_OBJECT}, &routine::notImplemented);
    add("SetFormation", R_VOID, {R_OBJECT, R_OBJECT, R_INT, R_INT}, &routine::notImplemented);
    add("ActionFollowLeader", R_VOID, {}, &routine::actionFollowLeader);
    add("SetForcePowerUnsuccessful", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
    ...
    add("GetPlanetSelectable", R_INT, {R_INT}, &routine::notImplemented);
    add("SetPlanetAvailable", R_VOID, {R_INT, R_INT}, &routine::setPlanetAvailable);
    add("GetPlanetAvailable", R_INT, {R_INT}, &routine::notImplemented);
    ...
    add("SetAreaFogColor", R_VOID, {R_OBJECT, R_FLOAT, R_FLOAT, R_FLOAT}, &routine::notImplemented);
    ...
    add("SetGoodEvilValue", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    ...
    add("SuppressStatusSummaryEntry", R_VOID, {R_INT}, &routine::notImplemented);
    ...
    add("IsMoviePlaying", R_INT, {}, &routine::notImplemented);
...
void Routines::initForTSL() {
    ...
    add("GetItemComponent", R_INT, {}, &routine::notImplemented);
    add("GetItemComponentPieceValue", R_INT, {}, &routine::notImplemented);
    add("ShowChemicalUpgradeScreen", R_VOID, {R_OBJECT}, &routine::showChemicalUpgradeScreen);
    add("GetChemicals", R_INT, {}, &routine::notImplemented);
    add("GetChemicalPieceValue", R_INT, {}, &routine::notImplemented);
    ...
    add("EffectFPRegenModifier", R_EFFECT, {R_INT}, &routine::notImplemented);
    ...
    add("GetRacialSubType", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("SetBonusForcePoints", R_VOID, {R_OBJECT, R_INT}, &routine::notImplemented);
    add("AddBonusForcePoints", R_VOID, {R_OBJECT, R_INT}, &routine::addBonusForcePoints);
    add("GetBonusForcePoints", R_VOID, {R_OBJECT}, &routine::notImplemented);
    ...
    add("EffectDroidConfused", R_EFFECT, {}, &routine::notImplemented);
    add("IsStealthed", R_INT, {R_OBJECT}, &routine::isStealthed);
    add("IsMeditating", R_INT, {R_OBJECT}, &routine::isMeditating);
    add("IsInTotalDefense", R_INT, {R_OBJECT}, &routine::notImplemented);
    ...
    add("GetSpellFormMask", R_INT, {R_INT}, &routine::notImplemented);
    ...
    add("ShowDemoScreen", R_INT, {R_STRING, R_INT, R_INT, R_INT, R_INT}, &routine::notImplemented);
    ...
    add("AddAvailablePUPByTemplate", R_INT, {R_INT, R_STRING}, &routine::notImplemented);
    ...
    add("AddPartyPuppet", R_INT, {R_INT, R_OBJECT}, &routine::notImplemented);
    ...
    add("EnableRain", R_VOID, {R_INT}, &routine::notImplemented);
    ...
    add("SaveNPCByObject", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
    add("SavePUPByObject", R_VOID, {R_INT, R_OBJECT}, &routine::notImplemented);
