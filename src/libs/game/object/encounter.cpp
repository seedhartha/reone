...
void Encounter::loadFromGIT(const resource::generated::GIT_Encounter_List &git) {
...
void Encounter::loadFromBlueprint(const std::string &blueprintResRef) {
    ...
    if (ute) {
        auto uteParsed = resource::generated::parseUTE(*ute);
        loadUTE(uteParsed);
    }
}

void Encounter::loadPositionFromGIT(const resource::generated::GIT_Encounter_List &git) {
...
void Encounter::loadGeometryFromGIT(const resource::generated::GIT_Encounter_List &git) {
...
void Encounter::loadSpawnPointsFromGIT(const resource::generated::GIT_Encounter_List &git) {
...
void Encounter::loadUTE(const resource::generated::UTE &ute) {
...
void Encounter::loadCreaturesFromUTE(const resource::generated::UTE &ute) {
