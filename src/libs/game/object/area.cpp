...
void Area::load(std::string name, const Gff &are, const Gff &git, bool fromSave) {
    ...
    auto areParsed = generated::parseARE(are);
    auto gitParsed = generated::parseGIT(git);
...
void Area::loadARE(const generated::ARE &are) {
...
void Area::loadCameraStyle(const generated::ARE &are) {
    // Area
...
void Area::loadAmbientColor(const generated::ARE &are) {
...
void Area::loadScripts(const generated::ARE &are) {
...
void Area::loadMap(const generated::ARE &are) {
    _game.map().load(_name, are.Map);
}

void Area::loadStealthXP(const generated::ARE &are) {
...
void Area::loadGrass(const generated::ARE &are) {
...
void Area::loadFog(const generated::ARE &are) {
...
void Area::loadGIT(const generated::GIT &git) {
    loadProperties(git);
    loadCreatures(git);
    loadDoors(git);
    loadPlaceables(git);
...
void Area::loadProperties(const generated::GIT &git) {
...
void Area::loadCreatures(const generated::GIT &git) {
...
void Area::loadDoors(const generated::GIT &git) {
...
void Area::loadPlaceables(const generated::GIT &git) {
...
void Area::loadWaypoints(const generated::GIT &git) {
...
void Area::loadTriggers(const generated::GIT &git) {
...
void Area::loadSounds(const generated::GIT &git) {
...
void Area::loadCameras(const generated::GIT &git) {
...
void Area::loadEncounters(const generated::GIT &git) {
...
void Area::loadStores(const generated::GIT &git) {
