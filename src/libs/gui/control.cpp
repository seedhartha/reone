...
ControlType Control::getType(const generated::GUI_BASECONTROL &gui) {
    return static_cast<ControlType>(gui.CONTROLTYPE);
}

std::string Control::getTag(const generated::GUI_BASECONTROL &gui) {
    return gui.TAG;
}

std::string Control::getParent(const generated::GUI_BASECONTROL &gui) {
...
void Control::load(const generated::GUI_BASECONTROL &gui, bool protoItem) {
    ...
    if (static_cast<ControlType>(gui.CONTROLTYPE) == ControlType::Panel) {
        ...
        auto &protoItem = *static_cast<const generated::GUI_CONTROLS_PROTOITEM *>(&gui);
        if (protoItem.TEXT) {
...
void Control::loadExtent(const generated::GUI_EXTENT &gui) {
...
void Control::loadBorder(const generated::GUI_BORDER &gui) {
...
void Control::loadText(const generated::GUI_TEXT &gui) {
...
void Control::loadHilight(const generated::GUI_BORDER &gui) {
    std::string corner(gui.CORNER);
    std::string edge(gui.EDGE);
    std::string fill(gui.FILL);
