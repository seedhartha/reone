...
void RoutineManager::addKotorRoutines() {
    ...
    add("EffectDeath", Effect, { Int, Int });
    ...
    add("ActionStartConversation", Void, { Object, String, Int, Int, Int, String, String, String, String, String, String, Int }, bind(&RoutineManager::actionStartConversation, this, _1, _2));
    ...
    add("DestroyObject", Void, { Object, Float, Int, Float }, bind(&RoutineManager::destroyObject, this, _1, _2));
    ...
    add("GetGlobalBoolean", Int, { String }, bind(&RoutineManager::getGlobalBoolean, this, _1, _2));
    add("SetGlobalBoolean", Void, { String, Int }, bind(&RoutineManager::setGlobalBoolean, this, _1, _2));
    add("GetGlobalNumber", Int, { String }, bind(&RoutineManager::getGlobalNumber, this, _1, _2));
    add("SetGlobalNumber", Void, { String, Int }, bind(&RoutineManager::setGlobalNumber, this, _1, _2));
    ...
    add("GetLocalBoolean", Int, { Object, Int }, bind(&RoutineManager::getLocalBoolean, this, _1, _2));
    add("SetLocalBoolean", Void, { Object, Int, Int }, bind(&RoutineManager::setLocalBoolean, this, _1, _2));
    add("GetLocalNumber", Int, { Object, Int }, bind(&RoutineManager::getLocalNumber, this, _1, _2));
    add("SetLocalNumber", Void, { Object, Int, Int }, bind(&RoutineManager::setLocalNumber, this, _1, _2));
