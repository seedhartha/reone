...
void initTslRoutines() {
    ...
    routines.add("CreateItemOnObject", Object, { String, Object, Int, Int });
    ...
    routines.add("EffectResurrection", Effect, { Int });
    ...
    routines.add("d10", Int, { Int });
    routines.add("d12", Int, { Int });
    routines.add("d20", Int, { Int });
    routines.add("d100", Int, { Int });
    ...
    routines.add("EffectDeath", Effect, { Int, Int, Int });
    ...
    routines.add("AdjustAlignment", Void, { Object, Int, Int, Int });
    routines.add("ActionWait", Void, { Float });
    routines.add("SetAreaTransitionBMP", Void, { Int, String });
    routines.add("ActionStartConversation", Void, { Object, String, Int, Int, Int, String, String, String, String, String, String, Int, Int, Int, Int }, actionStartConversation);
    ...
    routines.add("DestroyObject", Void, { Object, Float, Int, Float, Int });
    ...
    routines.add("GetIsInCombat", Int, { Object, Int });
    ...
    routines.add("ShowUpgradeScreen", Void, { Object, Object, Int, Int, String });
    ...
    routines.add("MusicBackgroundChangeDay", Void, { Object, Int, Int });
    routines.add("MusicBackgroundChangeNight", Void, { Object, Int, Int });
    ...
    routines.add("BarkString", Void, { Object, Int, Int, Int });
    ...
    routines.add("ShowPartySelectionGUI", Void, { String, Int, Int, Int });
    ...
    routines.add("PlayMovie", Void, { String, Int });
    ...
    routines.add("GetScriptParameter", Int, { Int });
    routines.add("SetFadeUntilScript", Void, { });
    routines.add("EffectForceBody", Effect, { Int });
    routines.add("GetItemComponent", Int, { });
    routines.add("GetItemComponentPieceValue", Int, { });
    routines.add("ShowChemicalUpgradeScreen", Void, { Object });
    routines.add("GetChemicals", Int, { });
    routines.add("GetChemicalPieceValue", Int, { });
    routines.add("GetSpellForcePointCost", Int, { });
    routines.add("EffectFury", Effect, { });
    routines.add("EffectBlind", Effect, { });
    routines.add("EffectFPRegenModifier", Effect, { Int });
    routines.add("EffectVPRegenModifier", Effect, { Int });
    routines.add("EffectCrush", Effect, { });
    routines.add("SWMG_GetSwoopUpgrade", Int, { Int });
    routines.add("GetFeatAcquired", Int, { Int, Object });
    routines.add("GetSpellAcquired", Int, { Int, Object });
    routines.add("ShowSwoopUpgradeScreen", Void, { });
    routines.add("GrantFeat", Void, { Int, Object });
    routines.add("GrantSpell", Void, { Int, Object });
    routines.add("SpawnMine", Void, { Int, Location, Int, Int, Object });
    routines.add("SWMG_GetTrackPosition", Vector, { Object });
    routines.add("SWMG_SetFollowerPosition", Vector, { Vector });
    routines.add("SetFakeCombatState", Void, { Object, Int });
    routines.add("SWMG_DestroyMiniGameObject", Void, { Object });
    routines.add("GetOwnerDemolitionsSkill", Int, { Object });
    routines.add("SetOrientOnClick", Void, { Object, Int });
    routines.add("GetInfluence", Int, { Int });
    routines.add("SetInfluence", Void, { Int, Int });
    routines.add("ModifyInfluence", Void, { Int, Int });
    routines.add("GetRacialSubType", Int, { Object });
    routines.add("IncrementGlobalNumber", Void, { String, Int });
    routines.add("DecrementGlobalNumber", Void, { String, Int });
    routines.add("SetBonusForcePoints", Void, { Object, Int });
    routines.add("AddBonusForcePoints", Void, { Object, Int });
    routines.add("GetBonusForcePoints", Void, { Object });
    routines.add("SWMG_SetJumpSpeed", Void, { Float });
    routines.add("IsMoviePlaying", Int, { });
    routines.add("QueueMovie", Void, { String, Int });
    routines.add("PlayMovieQueue", Void, { Int });
    routines.add("YavinHackDoorClose", Void, { Object });
    routines.add("EffectDroidConfused", Effect, { });
    routines.add("IsStealthed", Int, { Object });
    routines.add("IsMeditating", Int, { Object });
    routines.add("IsInTotalDefense", Int, { Object });
    routines.add("SetHealTarget", Void, { Object, Object });
    routines.add("GetHealTarget", Object, { Object });
    routines.add("GetRandomDestination", Vector, { Object, Int });
    routines.add("IsFormActive", Int, { Object, Int });
    routines.add("GetSpellFormMask", Int, { Int });
    routines.add("GetSpellBaseForcePointCost", Int, { Int });
    routines.add("SetKeepStealthInDialog", Void, { Int });
    routines.add("HasLineOfSight", Int, { Vector, Vector, Object, Object });
    routines.add("ShowDemoScreen", Int, { String, Int, Int, Int, Int });
    routines.add("ForceHeartbeat", Void, { Object });
    routines.add("EffectForceSight", Effect, { });
    routines.add("IsRunning", Int, { Object });
    routines.add("SWMG_PlayerApplyForce", Void, { Vector });
    routines.add("SetForfeitConditions", Void, { Int });
    routines.add("GetLastForfeitViolation", Int, { });
    routines.add("ModifyReflexSavingThrowBase", Void, { Object, Int });
    routines.add("ModifyFortitudeSavingThrowBase", Void, { Object, Int });
    routines.add("ModifyWillSavingThrowBase", Void, { Object, Int });
    routines.add("GetScriptStringParameter", String, { });
    routines.add("GetObjectPersonalSpace", Float, { Object });
    routines.add("AdjustCreatureAttributes", Void, { Object, Int, Int });
    routines.add("SetCreatureAILevel", Void, { Object, Int });
    routines.add("ResetCreatureAILevel", Void, { Object });
    routines.add("AddAvailablePUPByTemplate", Int, { Int, String });
    routines.add("AddAvailablePUPByObject", Int, { Int, Object });
    routines.add("AssignPUP", Int, { Int, Int });
    routines.add("SpawnAvailablePUP", Object, { Int, Location });
    routines.add("AddPartyPuppet", Int, { Int, Object });
    routines.add("GetPUPOwner", Object, { Object });
    routines.add("GetIsPuppet", Int, { Object });
    routines.add("ActionFollowOwner", Void, { Float });
    routines.add("GetIsPartyLeader", Int, { Object });
    routines.add("GetPartyLeader", Object, { });
    routines.add("RemoveNPCFromPartyToBase", Int, { Int });
    routines.add("CreatureFlourishWeapon", Void, { Object });
    routines.add("EffectMindTrick", Effect, { });
    routines.add("EffectFactionModifier", Effect, { Int });
    routines.add("ChangeObjectAppearance", Void, { Object, Int });
    routines.add("GetIsXBox", Int, { });
    routines.add("EffectDroidScramble", Effect, { });
    routines.add("ActionSwitchWeapons", Void, { });
    routines.add("PlayOverlayAnimation", Void, { Object, Int });
    routines.add("UnlockAllSongs", Void, { });
    routines.add("DisableMap", Void, { Int });
    routines.add("DetonateMine", Void, { Object });
    routines.add("DisableHealthRegen", Void, { Int });
    routines.add("SetCurrentForm", Void, { Object, Int });
    routines.add("SetDisableTransit", Void, { Int });
    routines.add("SetInputClass", Void, { Int });
    routines.add("SetForceAlwaysUpdate", Void, { Object, Int });
    routines.add("EnableRain", Void, { Int });
    routines.add("DisplayMessageBox", Void, { Int, String });
    routines.add("DisplayDatapad", Void, { Object });
    routines.add("RemoveHeartbeat", Void, { Object });
    routines.add("RemoveEffectByID", Void, { Object, Int });
    routines.add("RemoveEffectByExactMatch", Void, { Object, Effect });
    routines.add("AdjustCreatureSkills", Void, { Object, Int, Int });
    routines.add("GetSkillRankBase", Int, { Int, Object });
    routines.add("EnableRendering", Void, { Object, Int });
    routines.add("GetCombatActionsPending", Int, { Object });
    routines.add("SaveNPCByObject", Void, { Int, Object });
    routines.add("SavePUPByObject", Void, { Int, Object });
    routines.add("GetIsPlayerMadeCharacter", Int, { Object });
    routines.add("RebuildPartyTable", Void, { });
}
