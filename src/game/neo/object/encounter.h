...
public:
    class Builder : public Object::Builder<Encounter, Builder> {
    public:
        std::unique_ptr<Encounter> build() override {
            return std::make_unique<Encounter>(
                _id,
                _tag,
                _sceneNode,
                *_sceneGraph);
    ...
    public:
        ...
        std::unique_ptr<Encounter> load(const resource::GffStruct &gitEntry);
