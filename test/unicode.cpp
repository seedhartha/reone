...
BOOST_AUTO_TEST_CASE(should_convert_utf8_to_utf16) {
    // given
    auto expected = std::u16string(u"Hello, world!");

    // when
    auto actual = reone::convertUTF8ToUTF16(std::string("Hello, world!"));
...
BOOST_AUTO_TEST_CASE(should_convert_utf16_to_utf8) {
    ...
    // when
    auto actual = reone::convertUTF16ToUTF8(std::u16string(u"Hello, world!"));
