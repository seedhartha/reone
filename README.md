...
**I am in the process of rewriting the game logic with memory safety and design uniformity in mind. Use [stable](https://github.com/seedhartha/reone/tree/stable) branch in order to access the previous iteration.**
