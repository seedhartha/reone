...
GLM_FUNC_QUALIFIER uint32 packFragment2x11_1x10(vec3 const &v) {
    return ((detail::floatTo11bit(v.x) & ((1 << 11) - 1)) << 0) |
           ((detail::floatTo11bit(v.y) & ((1 << 11) - 1)) << 11) |
           ((detail::floatTo10bit(v.z) & ((1 << 10) - 1)) << 22);
}

GLM_FUNC_QUALIFIER vec3 unpackFragment2x11_1x10(uint32 v) {
    return vec3(
...
GLM_FUNC_QUALIFIER uint32 packFragment3x9_E1x5(vec3 const &v) {
...
GLM_FUNC_QUALIFIER vec3 unpackFragment3x9_E1x5(uint32 v) {
    detail::u9u9u9e5 Unpack;
    Unpack.pack = v;
