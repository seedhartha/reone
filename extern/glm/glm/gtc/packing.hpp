...
///
/// @see gtc_packing
/// @see vec3 unpackFragment2x11_1x10(uint32 const& p)
GLM_FUNC_DECL uint32 packFragment2x11_1x10(vec3 const &v);
...
///
/// @see gtc_packing
/// @see uint32 packFragment2x11_1x10(vec3 const& v)
GLM_FUNC_DECL vec3 unpackFragment2x11_1x10(uint32 p);
...
/// the last component specifies the 10 most-significant bits.
///
/// packFragment3x9_E1x5 allows encoding into RGBE / RGB9E5 format
///
/// @see gtc_packing
/// @see vec3 unpackFragment3x9_E1x5(uint32 const& p)
GLM_FUNC_DECL uint32 packFragment3x9_E1x5(vec3 const &v);
...
/// the last component will be extracted from the most significant bits.
///
/// unpackFragment3x9_E1x5 allows decoding RGBE / RGB9E5 data
///
/// @see gtc_packing
/// @see uint32 packFragment3x9_E1x5(vec3 const& v)
GLM_FUNC_DECL vec3 unpackFragment3x9_E1x5(uint32 p);
