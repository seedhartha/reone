...
class GUI_optautopause : gui::IGUI, boost::noncopyable {
public:
    void bindControls() {
        _controls.BTN_BACK = findControl<gui::Button>("BTN_BACK");
        _controls.BTN_DEFAULT = findControl<gui::Button>("BTN_DEFAULT");
        _controls.CB_ACTIONMENU = findControl<gui::ToggleButton>("CB_ACTIONMENU");
        _controls.CB_ENDROUND = findControl<gui::ToggleButton>("CB_ENDROUND");
        _controls.CB_ENEMYSIGHTED = findControl<gui::ToggleButton>("CB_ENEMYSIGHTED");
        _controls.CB_MINESIGHTED = findControl<gui::ToggleButton>("CB_MINESIGHTED");
        _controls.CB_PARTYKILLED = findControl<gui::ToggleButton>("CB_PARTYKILLED");
        _controls.CB_TRIGGERS = findControl<gui::ToggleButton>("CB_TRIGGERS");
        ...
        _controls.LB_DETAILS = findControl<gui::ListBox>("LB_DETAILS");
    }
