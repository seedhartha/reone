...
class GUI_component : gui::IGUI, boost::noncopyable {
public:
    void bindControls() {
        _controls.BTN_Accept = findControl<gui::Button>("BTN_Accept");
        _controls.BTN_BREAK_ALL = findControl<gui::Button>("BTN_BREAK_ALL");
        _controls.BTN_BREAK_ARMOR = findControl<gui::Button>("BTN_BREAK_ARMOR");
        _controls.BTN_BREAK_MISC = findControl<gui::Button>("BTN_BREAK_MISC");
        _controls.BTN_BREAK_USEABLE = findControl<gui::Button>("BTN_BREAK_USEABLE");
        _controls.BTN_BREAK_WEAPONS = findControl<gui::Button>("BTN_BREAK_WEAPONS");
        _controls.BTN_CREATE_ARMOR = findControl<gui::Button>("BTN_CREATE_ARMOR");
        _controls.BTN_CREATE_LIGHTSABER = findControl<gui::Button>("BTN_CREATE_LIGHTSABER");
        _controls.BTN_CREATE_MELEE = findControl<gui::Button>("BTN_CREATE_MELEE");
        _controls.BTN_CREATE_MISC = findControl<gui::Button>("BTN_CREATE_MISC");
        _controls.BTN_CREATE_RANGED = findControl<gui::Button>("BTN_CREATE_RANGED");
...
private:
    struct Controls {
        ...
        std::shared_ptr<gui::Button> BTN_BREAK_ALL;
        std::shared_ptr<gui::Button> BTN_BREAK_ARMOR;
        std::shared_ptr<gui::Button> BTN_BREAK_MISC;
        std::shared_ptr<gui::Button> BTN_BREAK_USEABLE;
        std::shared_ptr<gui::Button> BTN_BREAK_WEAPONS;
        std::shared_ptr<gui::Button> BTN_CREATE_ARMOR;
        std::shared_ptr<gui::Button> BTN_CREATE_LIGHTSABER;
        std::shared_ptr<gui::Button> BTN_CREATE_MELEE;
        std::shared_ptr<gui::Button> BTN_CREATE_MISC;
        std::shared_ptr<gui::Button> BTN_CREATE_RANGED;
