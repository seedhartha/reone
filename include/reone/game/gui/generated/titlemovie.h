...
class GUI_titlemovie : gui::IGUI, boost::noncopyable {
public:
    void bindControls() {
        ...
        _controls.LBL_UNLOCKED_VALUE = findControl<gui::Label>("LBL_UNLOCKED_VALUE");
        _controls.LB_MOVIES = findControl<gui::ListBox>("LB_MOVIES");
    }
...
private:
    struct Controls {
        ...
        std::shared_ptr<gui::Label> LBL_UNLOCKED_VALUE;
        std::shared_ptr<gui::ListBox> LB_MOVIES;
    };
