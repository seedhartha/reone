...
class GUI_optsound : gui::IGUI, boost::noncopyable {
public:
    void bindControls() {
        ...
        _controls.LBL_FX = findControl<gui::Label>("LBL_FX");
        _controls.LBL_MOVIE = findControl<gui::Label>("LBL_MOVIE");
        _controls.LBL_MUSIC = findControl<gui::Label>("LBL_MUSIC");
        _controls.LBL_TITLE = findControl<gui::Label>("LBL_TITLE");
        _controls.LBL_VO = findControl<gui::Label>("LBL_VO");
        _controls.LB_DESC = findControl<gui::ListBox>("LB_DESC");
        _controls.SLI_FX = findControl<gui::Slider>("SLI_FX");
        _controls.SLI_MOVIE = findControl<gui::Slider>("SLI_MOVIE");
        _controls.SLI_MUSIC = findControl<gui::Slider>("SLI_MUSIC");
        _controls.SLI_VO = findControl<gui::Slider>("SLI_VO");
    }
...
private:
    struct Controls {
        ...
        std::shared_ptr<gui::Label> LBL_FX;
        std::shared_ptr<gui::Label> LBL_MOVIE;
        std::shared_ptr<gui::Label> LBL_MUSIC;
        std::shared_ptr<gui::Label> LBL_TITLE;
        std::shared_ptr<gui::Label> LBL_VO;
        std::shared_ptr<gui::ListBox> LB_DESC;
        std::shared_ptr<gui::Slider> SLI_FX;
        std::shared_ptr<gui::Slider> SLI_MOVIE;
        std::shared_ptr<gui::Slider> SLI_MUSIC;
        std::shared_ptr<gui::Slider> SLI_VO;
    };
