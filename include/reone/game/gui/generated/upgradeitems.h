...
class GUI_upgradeitems : gui::IGUI, boost::noncopyable {
public:
    void bindControls() {
        _controls.BTN_BACK = findControl<gui::Button>("BTN_BACK");
        _controls.BTN_UPGRADEITEM = findControl<gui::Button>("BTN_UPGRADEITEM");
...
private:
    struct Controls {
        ...
        std::shared_ptr<gui::Button> BTN_UPGRADEITEM;
