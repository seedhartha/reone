...
public:
    ...
    static ControlType getType(const generated::GUI_BASECONTROL &gui);
    static std::string getTag(const generated::GUI_BASECONTROL &gui);
    static std::string getParent(const generated::GUI_BASECONTROL &gui);

    virtual ~Control() = default;

    virtual void load(const generated::GUI_BASECONTROL &gui, bool protoItem = false);
...
private:
    void loadExtent(const generated::GUI_EXTENT &gui);
    void loadBorder(const generated::GUI_BORDER &gui);
    void loadText(const generated::GUI_TEXT &gui);
    void loadHilight(const generated::GUI_BORDER &gui);
